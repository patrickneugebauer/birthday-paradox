...
`lein --version`
    ...
    Leiningen 2.8.1 on Java 1.8.0_242 OpenJDK 64-Bit Server VM
...
`dart --version`
    ...
    Dart VM version: 2.7.2 (Unknown timestamp) on "linux_x64"
...
`hhvm --version`
    ...
    HipHop VM 4.52.1 (rel)
    Compiler: 1586290825_799901291
...
`kotlinc -version`
    ...
    info: kotlinc-jvm 1.2.60 (JRE 11.0.6+10-post-Ubuntu-1ubuntu118.04.1)
